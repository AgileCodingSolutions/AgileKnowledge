...
import ChatAppList from "../../chat/features/ChatList";
import { ChatApplicationService } from '../../../services/service-proxies';
import { Flexbox } from 'react-layout-kit';
import constructWithOptions from "styled-components/dist/constructors/constructWithOptions";
import Item from "@lobehub/ui/es/ChatList/Item";
...
export default function DesktopLayout() {
    ...
    async function loadingApplications() {
        try {
            const result = await chatApplicationService.getList("","",input.page,input.pageSize);
    ...
    async function deleteDialog(id: string) {
        try {
            ...
            await chatApplicationService.deleteChatDialog(id);
            loadingDialogs();
